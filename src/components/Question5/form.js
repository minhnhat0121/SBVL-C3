  ...
  return (
   ...
   <Row className="mb-3">
      <Form.Group as={Col} controlId="formGridPassword">
         <Form.Label style={{color: "#003566", fontWeight: "bold"}}>Nhập Fab</Form.Label>
         <Form.Control type="number" placeholder="Nhập Fab" className='paramFAB' />
      </Form.Group>
      <Form.Group as={Col} controlId="formGridPassword">
         <Form.Label style={{color: "#003566", fontWeight: "bold"}}>Nhập Fcd</Form.Label>
         <Form.Control type="number" placeholder="Nhập Fcd" className='paramFCD' />
      </Form.Group>
   </Row>
